...
//todo: add option to mark a dependency of a mockrequired module to be replaced by a stub/spy and not just its methods, useful for types
...
var RequireMocker = (function () {
     ...
     * @param mockType (use RequireMocker.MOCK_TYPES)
     */
