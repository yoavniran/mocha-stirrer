...
var blender = (function () {
    ...
    function blend(conf) {
        ...
        var cup = {
            ...
            _afters: [],
            _hooks: {},
            _it: global.it //use mocha's it test function, currently only here for helping a few unittest cases
        };
    ...
    var _cupBody = (function () {
        ...
        function _stirRequires(requires){
        ...
        function _stir(conf) {
            ...
            _stirRequires.call(this, conf.requires);
        }
