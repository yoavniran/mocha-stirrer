...
var stirrer = (function () {
	...
	/**
	 * get the separator char used to create stub aliases when using fake require with a cup instance.
	 * The default is "/". a single separator char is used in order to allow the same stub alias to be created
	 * regardless of the OS used (since Windows defers from MacOS/Linux)
	 */
	function getSeparator() {
		return stirrer_globals.separator;
	}
	
	/**
	* set the separator char used to create stub aliases when using fake require with a cup instance. 
	*/
	function setSeparator(sep) {
		stirrer_globals.separator = sep;
	}
