 ...
 */
Mocker.prototype.require = function (parent, requirePath, setupFn, options) {
...
function _stubRequiredModule(mocker, path, resolvedPath, options, parent) {
    ...
    if (!stub) {
        ...
        if (_dontStub(path, resolvedPath, options.dontStub)) { //dont stub, use as is
            console.log(" $$$$$$$$$$$$$$$$$ ---- *NOT* STUBBING !!!!!!! - " + resolvedPath);
        }
        else {
